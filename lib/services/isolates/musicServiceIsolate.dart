...
import 'package:flutter_tunein_attempt3/plugins/AudioReceiverService.dart';
import 'package:flutter_tunein_attempt3/plugins/ThemeReceiverService.dart';
import 'package:flutter_tunein_attempt3/plugins/nano.dart';
import 'package:flutter_tunein_attempt3/services/http/server/httpOutgoingServer.dart';
import 'package:flutter_tunein_attempt3/services/isolates/pluginIsolateFunctions.dart';
...
import 'package:flutter_tunein_attempt3/plugins/upnp.dart' as UPnPPlugin;
import 'package:upnp/upnp.dart';
import 'package:flutter_file_meta_data/flutter_file_meta_data.dart';

class musicServiceIsolate {
  static BehaviorSubject<MapEntry<PlayerState, Tune>> _playerState$ =
      BehaviorSubject<MapEntry<PlayerState, Tune>>.seeded(
    MapEntry(
      PlayerState.stopped,
...
// default port to receive on
  ...
  Future<dynamic> sendReceive(String messageToBeSent) async {
    ...
    newIsolateSendPort!.send(CrossIsolatesMessage<String>(
        sender: port.sendPort, message: messageToBeSent, command: ""));
  ...
  Future<dynamic> sendCrossIsolateMessage(
    ...
    messageToBeSent = new CrossIsolatesMessage(
        sender: messageToBeSent.sender == null
            ? port.sendPort
            : messageToBeSent.sender,
  ...
  Future<dynamic> sendCrossPluginIsolatesMessage(
    ...
    newPluginEnabledIsolateSendPort!.send([
      messageToBeSent.command,
    ...
    newIsolateReceivePort.listen((dynamic message) {
      ...
      switch (incomingMessage.command) {
        ...
        case "readExternalDirectory":
          {
            if (incomingMessage.message != null) {
              StandardIsolateFunctions.readExtDir(incomingMessage.message,
                  (dataPath) {
        ...
        case "encodeSongsToStringList":
          {
            if (incomingMessage.message != null) {
              StandardIsolateFunctions.saveSongsToPref(incomingMessage.message,
                  (data) {
                incomingMessage.sender!.send(data);
              });
            }
        ...
        case "fetchAlbumsFromSongs":
          {
            if (incomingMessage.message != null) {
              StandardIsolateFunctions.fetchAlbumFromsongs(
                  incomingMessage.message, callback: (data) {
                incomingMessage.sender!.send(data);
              });
            }
            break;
        ...
        case "encodeArtistsToStringList":
          {
            if (incomingMessage.message != null) {
              StandardIsolateFunctions.saveArtiststoPref(
        ...
        case "getTopAlbums":
          {
            if (incomingMessage.message != null) {
              List<dynamic> segmentedMessage =
                  incomingMessage.message as List<dynamic>;
              StandardIsolateFunctions.getTopAlbum(
                  segmentedMessage[0], segmentedMessage[1], segmentedMessage[2],
                  (data) {
                incomingMessage.sender!.send(data);
              });
            }
        ...
        case "getMostPlayedSongs":
          {
            if (incomingMessage.message != null) {
              List<dynamic> segmentedMessage =
                  incomingMessage.message as List<dynamic>;
              StandardIsolateFunctions.getMostPlayedSongs(
                  segmentedMessage[0], segmentedMessage[1], segmentedMessage[2],
                  (data) {
                incomingMessage.sender!.send(data);
              });
        ...
        case "createServerAndAddFilesHosting":
          {
            if (incomingMessage.message != null) {
              List<dynamic> segmentedMessage =
                  incomingMessage.message as List<dynamic>;
              StandardIsolateFunctions.createServerAndAddImagesAndFiles(
                  segmentedMessage[0],
                  segmentedMessage[1],
                  (value) => (incomingMessage.sender as SendPort).send(value));
            }
            break;
          }
        default:
    ...
    newIsolateReceivePort.listen((dynamic message) {
      ...
      switch (incomingMessage[0] as String) {
        ...
        case "getAllTracksMetadata":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.fetchMetadataOfAllTracks(
                  incomingMessage[1], callback: (data) {
        ...
        case "writeImage":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.writeImage(null, incomingMessage[1])
                  .then((data) {
        ...
        case "seekMusic":
          {
            if (incomingMessage[1] != null) {
              audioReceiverService
                  .seek(double.tryParse(incomingMessage[1])!)
                  .then((data) => (incomingMessage[2] as SendPort).send(data));
            }
            break;
          }
        case "useAndroidNotification":
          {
            if (incomingMessage[1] != null) {
              ...
              audioReceiverService
                  .useNotification(
                      useNotification: args["useNotification"],
                      cancelWhenPlayingStops: args["cancelWhenNotPlaying"])
                  .then((data) => (incomingMessage[2] as SendPort).send(data));
            }
            break;
          }
        ...
        case "subscribeToPosition":
          {
            if (incomingMessage[1] != null) {
              audioReceiverService.onPositionChanges((position) =>
                  (incomingMessage[2] as SendPort).send(position));
            }
            break;
          }
        case "subscribeToState":
          {
            if (incomingMessage[1] != null) {
              audioReceiverService.onStateChanges(
                  (state) => (incomingMessage[2] as SendPort).send(state));
            }
            break;
          }
        case "subscribeToplaybackKeys":
          {
            if (incomingMessage[1] != null) {
              audioReceiverService.onPlaybackKeys(
                  (keys) => (incomingMessage[2] as SendPort).send(keys));
            }
            break;
          }
        case "showNotification":
          {
            if (incomingMessage[1] != null) {
              Map<String, dynamic> convertedMap =
                  json.decode(incomingMessage[1]);
              int? BigLayoutIconColor =
                  convertedMap["bigLayoutIconColor"] != null
                      ? int.tryParse(convertedMap["bigLayoutIconColor"])
                      : null;
              PluginIsolateFunctions.show(
                  ...
                  bgColor: convertedMap["bgColor"] != null
                      ? Color(int.tryParse(convertedMap["bgColor"])!)
                      : Colors.white,
                  BitmapImage: convertedMap["BitmapImage"] != null
                      ? Uint8List.fromList((convertedMap["BitmapImage"] as List)
                          .map((e) => int.tryParse(e.toString())!)
                          .toList())
                      : null,
                  iconColor: convertedMap["iconColor"] != null
                      ? Color(int.tryParse(convertedMap["iconColor"])!)
                      : Colors.white,
                  image: convertedMap["image"],
                  play: convertedMap["play"] ?? false,
                  subtitleColor: convertedMap["subtitleColor"] != null
                      ? Color(int.tryParse(convertedMap["subtitleColor"])!)
                      : Colors.white,
                  title: convertedMap["title"],
                  titleColor: convertedMap["titleColor"] != null
                      ? Color(int.tryParse(convertedMap["titleColor"])!)
                      : Colors.white,
                  bgImageBackgroundColor:
                      convertedMap["bgImageBackgroundColor"] != null
                          ? Color(int.tryParse(
                              convertedMap["bgImageBackgroundColor"])!)
                          : Colors.white,
                  bgBitmapImage: convertedMap["bgBitmapImage"] != null
                      ? Uint8List.fromList(
                          (convertedMap["bgBitmapImage"] as List)
                              .map((e) => int.tryParse(e.toString())!)
                              .toList())
                      : null,
              ...
              if (NotificationTimestampSub == null)
                NotificationTimestampSub =
                    audioReceiverService.onPositionChanges((position) =>
                        PluginIsolateFunctions.setNotificationTimeStamp(
                            ConversionUtils.DurationToStandardTimeDisplay(
        ...
        case "hideNotification":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.hide().then((value) {
                return NotificationTimestampSub!.cancel().then(
                    (canceled) => (incomingMessage[2] as SendPort).send(value));
              });
            }
            break;
          }
        case "subscribeToNext":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.subscribeToNextButton(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "subscribeToPrev":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.subscribeToPrevButton(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "subscribeToPlay":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.subscribeToPlayButton(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "subscribeToPause":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.subscribeToPauseButton(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "subscribeToSelect":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.subscribeToSelectButton(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "setTo":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.setNotificationTo(
                  incomingMessage[1] == "true",
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "setStatusIcon":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.setNotificationStatusIcon(
                  incomingMessage[1],
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
        ...
        case "setTitle":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.setNotificationTitle(incomingMessage[1],
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "setSubtitle":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.setNotificationSubTitle(incomingMessage[1],
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "togglePlaypauseButton":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.toggleNotificationPlayPause(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        case "sdCardPermission":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.getSDCardAndPermissions(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
        ...
        case "updateTheme":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.themeReceiverService
                  .execute(incomingMessage[0], incomingMessage[1])
                  .then(
                      (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
        ...
        case "LoadStarterFiles":
          {
            if (incomingMessage[1] != null) {
              PluginIsolateFunctions.loadFiles().then(
                  (value) => (incomingMessage[2] as SendPort).send(value));
            }
            break;
          }
  ...
  void _initStreams() {
    _playerState$.listen((data) {
      CrossIsolatesMessage messageToBeSent =
          CrossIsolatesMessage<MapEntry<PlayerState, Tune>>(
              sender: null, message: data, command: "UPlayerstate");

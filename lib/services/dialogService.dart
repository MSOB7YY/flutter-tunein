...
class DialogService {
  ...
  static showToast(context,
      {String? message, Color? color, Color? backgroundColor, int? duration}) {
    Toast.show(
      message,
      context,
      textStyle: TextStyle(color: color ?? MyTheme.grey300),
      duration: duration ?? 2,
      gravity: 0,
      backgroundRadius: 2,
  ...
  static Future<dynamic> showConfirmDialog(context,
      {String? message,
      Color? titleColor,
      Color? messageColor,
      String? title,
          ...
          return AlertDialog(
            ...
            content: content ??
                Text(
                  ...
                  style: TextStyle(
                      color:
                          messageColor != null ? messageColor : Colors.white),
                ),
  ...
  static Future openDevicePickingDialog(context, List<upnp.Device>? devices,
      {Widget? content}) {
    late Widget devicesNotSent;
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(color: MyTheme.grey300, fontSize: 18),
              ),
            ),
            Container(
              margin: EdgeInsets.only(top: 8),
              child: Text(
                ...
                style: TextStyle(color: MyTheme.grey300, fontSize: 17),
              ),
            )
          ],
        ),
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Text(
                                      "No Devices Found",
                                      style: TextStyle(
                                          color: MyTheme.grey300, fontSize: 17),
                                    ),
                                  )
                                ],
                              ),
  ...
  static Future<dynamic> showPersistentDialog(context,
      {String? message,
      Color? titleColor,
      Color? messageColor,
      String? title,

...
class upnp {
  late StateSubscriptionManager globalSub;
  late List<StateSubscriptionManager> individualSubs = [];
  upnp();

  Future<Map<String, dynamic>?> getCurrentMediaInfo(
      {required Service? service}) async {
    return await service?.invokeAction("GetMediaInfo", {"InstanceID": "0"});
  }
  ...
  Future<Map<String, dynamic>?> playCurrentMedia(
      {required Service? service, String? Speed}) async {
    return await service?.invokeAction("Play", {"InstanceID": "0", "Speed": Speed ?? "1"});
  }
  ...
  Future<Map<String, dynamic>?> getTransportSettings(
      {required Service? service}) async {
    return await service?.invokeAction("GetTransportSettings", {"InstanceID": "0"});
  }
  ...
  Future<Map<String, dynamic>?> getPositionInfo(
      {required Service? service}) async {
    return await service?.invokeAction("GetPositionInfo", {"InstanceID": "0"});
  }
  ...
  /// - PAUSED_PLAYBACK
  /// - STOPPED
  Future<Map<String, dynamic>?> getTransportInfo(
      {required Service? service}) async {
    return await service?.invokeAction("GetTransportInfo", {"InstanceID": "0"});
  }
  ...
  Future<Map<String, dynamic>?> getDeviceCapabilities(
      {required Service? service}) async {
    return await service?.invokeAction("GetDeviceCapabilities", {"InstanceID": "0"});
  }
  ...
  Future<Map<String, dynamic>?> getTransportActions(
      {required Service? service}) async {
    return await service?.invokeAction("GetCurrentTransportActions", {"InstanceID": "0"});
  }
  ...
  Future<Map<String, dynamic>?> setPlayMode(
      {required Service? service, String? playmode}) async {
  ...
  Future<Map<String, dynamic>?> setCurrentURI(
    ...
    return await service?.invokeAction("SetAVTransportURI", {
      "InstanceID": "0",
      "CurrentURI": uri ?? "",
      "CurrentURIMetaData": (htmlEscape.convert(xml.XmlDocument
          .parse(
  ...
  Future<Map<String, dynamic>?> goToPrevious({required Service? service}) async {
    return await service?.invokeAction("Previous", {"InstanceID": "0"});
  }

  Future<Map<String, dynamic>?> goToNext({required Service? service}) async {
    return await service?.invokeAction("Next", {"InstanceID": "0"});
  }
  ...
  Future<Map<String, dynamic>?> seekPostion(
      {required Service? service, String? position}) async {
  ...
  Future<BehaviorSubject<Map<String, String>?>> subscribeToService(
      {required Service? service, bool newSub = false}) async {
    var sub;
    late int subIndex;
  ...
  Future<bool> closeserviceSubscriptions({required List<int?> IDs}) {
    if (IDs != null) {
      IDs.forEach((elemID) {
        if (elemID! < individualSubs.length - 1 &&
            individualSubs[elemID] != null) {
  ...
  Future<List<Device>> getDevices() async {
    ...
    await discoverStream.forEach((client) async {
      try {
        ...
        var result =
            await dev.getService("urn:schemas-upnp-org:service:AVTransport:1");
        if (result != null) {

                    ...
                    return Row(
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                            ...
                            icon: Container(
                                decoration: BoxDecoration(color: new Color(colors![1]!).withOpacity(.7), borderRadius: BorderRadius.circular(30)),
                                height: 30,
                                width: 30,
                                child: Center(
                    ...
                    IconButton(
                        ...
                        icon: Container(
                            ...
                            child: Center(
                              child: AnimatedCrossFade(
                                duration: Duration(milliseconds: 200),
                                crossFadeState: state == PlayerState.playing ? CrossFadeState.showFirst : CrossFadeState.showSecond,
                                firstChild: Icon(
                                  Icons.pause,
                                  color: Color(colors![0]!),
                                  size: 20,

    ...
    return Material(
      ...
      child: Container(
          ...
          child: (this.state == null || this.currentSong == null)
              ? StreamBuilder<MapEntry<PlayerState, Tune>>(
                        ...
                        IconButton(
                            ...
                            icon: Container(
                                decoration: BoxDecoration(
                                    color:
                                        new Color(colors![1]!).withOpacity(.7),
                        ...
                        IconButton(
                            ...
                            icon: StreamBuilder(
                              ...
                              builder: (context,
                                ...
                                if (snapshot.hasData) {
                                  bool isSongRepeat = snapshot.data!
                                      .contains(Playback.repeatSong);
                                  bool isQueueRepeat = snapshot.data!
                                      .contains(Playback.repeatQueue);

  ...
  Widget build(BuildContext context) {
    ...
    newStream = newStream.where((item) {
      if (previousStreamEntry == null) {
        ...
        if ((previousStreamEntry!.value.id == item.value.id) &&
            (previousStreamEntry!.key != item.key)) {
          //no rebuild
          previousStreamEntry = item;
          return false;
        } else {
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: (!_isSelectedSong ||
                                                _song!.title!.length < 25)
                                            ? Text(
                                                (_song!.title == null)
                                                    ? "Unknon Title"
            ...
            if (snapshot.data!.key == previousState && previousState != null) {
              ...
              Widget newInstance = Material(
                color: _isSelectedSong
                    ? (selectedBackgrundColor != null
                            ? selectedBackgrundColor
                            : MyTheme.grey300)!
                        .withAlpha(10)
                    : Colors.transparent,

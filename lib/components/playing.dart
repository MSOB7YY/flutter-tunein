...
class _PlayingPageState extends State<PlayingPage>
  ...
  BehaviorSubject<MapEntry<MapEntry<PlayerState, Tune?>, List<Tune>>?>? newStream =
      BehaviorSubject<MapEntry<MapEntry<PlayerState, Tune?>, List<Tune>>?>();
    ...
    return StreamBuilder<MapEntry<MapEntry<PlayerState, Tune?>, List<Tune>>?>(
      ...
      builder: (BuildContext context,
        ...
        item.PopupMenu menu = item.PopupMenu(
          config: item.MenuConfig(backgroundColor: Color(colors![1]!), lineColor: Colors.transparent, maxColumn: 2),
            context: context,
            items: [
              item.MenuItem(
                  title: 'Album',

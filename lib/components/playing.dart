...
import 'package:flutter_tunein_attempt3/pages/single/singlePlaylistPage.dart';
...
import 'package:flutter_tunein_attempt3/components/slider.dart';
...
import 'package:flutter_tunein_attempt3/pages/single/playingQueue.dart';
...
class NowPlayingScreen extends StatefulWidget {
  ...
  NowPlayingScreen({super.key, controller}) {
    this.controller =
        controller != null ? controller : new PageController(initialPage: 1);
  }
...
class _PlayingPageState extends State<PlayingPage>
  ...
  BehaviorSubject<MapEntry<MapEntry<PlayerState, Tune>, List<Tune>>> newStream =
      new BehaviorSubject<MapEntry<MapEntry<PlayerState, Tune>, List<Tune>>>();
  ...
  @override
  void initState() {
    Stream<MapEntry<MapEntry<PlayerState, Tune>, List<Tune>>> originalStream =
        Rx.combineLatest2(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MapEntry<MapEntry<PlayerState, Tune>, List<Tune>>>(
      ...
      builder: (BuildContext context,
        ...
        MapEntry<PlayerState, Playlist?> currentPlaylist =
            musicService.currentPlayingPlaylist$.value;
        final List<int?>? colors =
            (_currentSong.colors != null && _currentSong.colors!.isNotEmpty)
                ? _currentSong.colors
        ...
        item.PopupMenu menu = item.PopupMenu(
            ...
            items: [
              item.MenuItem(
                  title: 'Album',
                  textStyle:
                      TextStyle(fontSize: 10.0, color: Color(colors[0]!)),
                  image: Icon(
                    Icons.album,
                    size: 30,
        ...
        Widget AlbumButton = InkWell(
          radius: 90.0,
          child: currentPlaylist.value != null
              ? Badge(
                  key: widgetKey,
                  child: Icon(
                    Icons.album,
                  ...
                  position: BadgePosition.topEnd(top: -9, end: -6),
                      ...
                      Material(
                        ...
                        child: Container(
                            ...
                            constraints: BoxConstraints(
                                maxHeight: _screenHeight / 2,
                                minHeight: _screenHeight / 2),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                                ...
                                children: <Widget>[
                                  Padding(
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        if (_isFavorited) {
                                          musicService.removeFromFavorites(
                                              _currentSong);
                                        } else {
                                          musicService
                                              .addToFavorites(_currentSong);
                                        }
                                      },
                                    ),
                                    padding:
                              ...
                              MusicBoardControls(colors,
                                  state: _state, currentSong: _currentSong),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  color: Color(colors[1]!),
                                  borderRadius: BorderRadius.circular(9.5708)),
                            ),
                          ],
                        ),
                      ),
  ...
  Widget build(BuildContext context) {
    if (widget.song != null) {
      ...
      return StreamBuilder<MapEntry<PlayerState, Tune>>(
        stream: widget.songStream as Stream<MapEntry<PlayerState, Tune>>?,
        builder: (BuildContext context,

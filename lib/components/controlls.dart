...
class MusicBoardControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    item.PopupMenu castMenu = item.PopupMenu(
        ...
        items: [
          item.MenuItem(
              ...
              image: Icon(IconData(0xf28d, fontFamily: "fontawesome"),
                  size: 27, color: MyTheme.darkBlack)),
          item.MenuItem(
              title: 'Search',
              textStyle: TextStyle(fontSize: 10.0, color: MyTheme.darkBlack),
              image: Icon(Icons.refresh, size: 30, color: MyTheme.darkBlack)),
        ],
            ...
            case "Search":
              {
                DialogService.openDevicePickingDialog(context, null)
                  ...
                  if (deviceChosen != null) {
                    castService
                        .isDeviceClear(awaitClearance: true)
                        .then((data) async {
                      if (data) {
    ...
    return Material(
      ...
      child: Container(
          ...
          child: (this.state == null || this.currentSong == null)
              ? Row(
                  ...
                  children: <Widget>[
                    IconButton(
                        ...
                        icon: StreamBuilder(
                          ...
                          builder: (context,
                            ...
                            Color iconColor =
                                new Color(colors![1]!).withOpacity(.5);
                            IconData iconToBe = Icons.repeat;
                            if (snapshot.hasData) {
                              bool isSongRepeat =
                                  snapshot.data!.contains(Playback.repeatSong);
                              bool isQueueRepeat =
                                  snapshot.data!.contains(Playback.repeatQueue);
                    ...
                    GestureDetector(
                      onLongPress: () {
                        if (castService.castingState.value ==
                            CastState.CASTING) {
                          if (castMenu.isShow) {
                            castMenu.dismiss();
                          } else {
                            castMenu.show(widgetKey: playButtonKey);
                          }
                        }
                      },
                      child: IconButton(
                          ...
                          icon: StreamBuilder(
                            ...
                            builder:
                                (context, AsyncSnapshot<CastState> snapshot) {
                        ...
                        icon: StreamBuilder(
                          ...
                          builder: (context,
                            ...
                            Color iconColor =
                                new Color(colors![1]!).withOpacity(.5);
                            if (snapshot.hasData &&
                                snapshot.data!.contains(Playback.shuffle)) {
                              iconColor = MyTheme.darkRed;
                            }
                            return Icon(
                              Icons.shuffle,

                ...
                Container(
                  ...
                  child: InkWell(
                    child: StreamBuilder(
                      ...
                      builder:
                          (context, AsyncSnapshot<List<Playback>> snapshot) {
                        Color iconColor = (song?.colors?.isNotEmpty ?? false) ? new Color(song?.colors?.elementAt(1)?.toInt() ?? MyTheme.grey300.value)
                            .withOpacity(.5) : MyTheme.darkRed;
                        if (snapshot.hasData &&

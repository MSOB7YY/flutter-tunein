...
import 'package:flutter_tunein_attempt3/components/drawer/DrawerControls.dart';
...
import 'package:flutter_tunein_attempt3/pages/single/AboutPage.dart';
...
class SideDrawerComponent extends StatelessWidget {
  GlobalKey<State<StatefulWidget>>? _innerDrawerKey;
  Widget? insideWidget;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot<MapEntry<PlayerState, Tune>> snapshot) {
        ...
        Color? primaryColor = (dataON &&
                data!.value.colors != null &&
                data.value.colors!.length != 0)
            ? Color(data.value.colors![0]!)
            : MyTheme.darkBlack;
        Color secondaryColor = (dataON &&
                data!.value.colors != null &&
                data.value.colors!.length != 0)
            ? Color(data.value.colors![1]!)
            : MyTheme.grey300;
        return InnerDrawer(
          key: _innerDrawerKey,
          ...
          colorTransitionChild:
              MyTheme.darkRed.withOpacity(.5), // default Color.black54
          ...
          backgroundDecoration: BoxDecoration(
            color: dataON && data!.value.colors!.length != 0
                ? Color(data.value.colors![0]!)
                : MyTheme.bgBottomBar,
          ),
                        ...
                        slivers: <Widget>[
                          ...
                          SliverToBoxAdapter(
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  child: (data!.value.title!.length < 25)
                                      ? Text(
                                      ...
                                      : Container(
                                          ...
                                          child: Marquee(
                                            ...
                                            blankSpace:
                                                data.value.title!.length * 2.0,
                                            velocity: (data.value.title == null)
                                                ? 30.0
                                                : data.value.title!.length *
                                                    1.2,
                          ...
                          SliverToBoxAdapter(
                            child: Container(
                              ...
                              child: DrawerMusicControls(
                                  entrySong: data.value, entryState: data.key),
                            ),
                          ),
                          SliverToBoxAdapter(
                            child: Container(

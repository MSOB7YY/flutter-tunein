...
class TrackListDeckComponent extends StatelessWidget {
                ...
                items: [
                  ...
                  item.MenuItem(
                      ...
                      textStyle: TextStyle(
                        fontSize: 10.0,
                        color: (deckItemState["filter"].isActive &&
                                deckItemState["filter"].activeNature == "album")
                            ? MyTheme.grey300.withOpacity(.9)
                            : MyTheme.darkBlack,
                      ),
                      image: Icon(
        ...
        case "album":
          {
            List<Album> albumsToFilterWith =
                await openFilteringAlbumDialog(context, null);
        ...
        case "artist":
          {
            List<Artist> artistsToFilterWith =
                await openFilteringArtistDialog(context, null);
  ...
  Future<List<Artist>> openFilteringArtistDialog(
      context, List<Artist> artists) {

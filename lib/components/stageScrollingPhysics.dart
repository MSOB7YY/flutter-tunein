...
class StageScrollingPhysics extends ScrollPhysics {
  ...
  StageScrollingPhysics(
      {ScrollPhysics? parent, this.stages, this.currentStage = 0})
      : super(parent: parent);

  @override
  StageScrollingPhysics applyTo(ScrollPhysics? ancestor) {
    return StageScrollingPhysics(
  ...
  Simulation createBallisticSimulation(
    ...
    if (target != position.pixels)
      return ScrollSpringSimulation(spring, position.pixels, target,
          position.pixels > target ? -200 : 200,
          tolerance: tolerance);
    return null as Simulation;
  }

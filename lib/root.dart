...
import 'package:flutter_tunein_attempt3/components/drawer/sideDrawer.dart';
import 'package:flutter_tunein_attempt3/models/playerstate.dart';
import 'package:flutter_tunein_attempt3/pages/collection/collection.page.dart';
import 'package:flutter_tunein_attempt3/pages/library/library.page.dart';
import 'package:flutter_tunein_attempt3/pages/settings/settings.page.dart';
          ...
          if (SettingsService.getOrCreateSingleSettingStream(
            ...
            NotificationService.show(
                ...
                BitmapImage: songToshowONNotification.albumArt == null
                    ? defaultImageBytes
                    : null,
                titleColor: songToshowONNotification.colors!.isNotEmpty
                    ? Color(songToshowONNotification.colors![1]!)
                    : MyTheme.grey300,
                subtitleColor: songToshowONNotification.colors!.isNotEmpty
                    ? Color(songToshowONNotification.colors![1]!).withAlpha(50)
                    : MyTheme.grey300,
                iconColor: songToshowONNotification.colors!.isNotEmpty
                    ? Color(songToshowONNotification.colors![1]!)
                    : MyTheme.grey300,
                bigLayoutIconColor:
                ...
                bgImageBackgroundColor:
                    (artist.colors != null && artist.colors.isNotEmpty)
                        ...
                        : MyTheme.darkBlack,
                bgColor: songToshowONNotification.colors!.isNotEmpty

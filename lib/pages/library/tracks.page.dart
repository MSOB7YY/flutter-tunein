...
import 'package:popup_menu/popup_menu.dart' as item;
import 'package:popup_menu/popup_menu.dart';
import 'package:rxdart/rxdart.dart';
import 'package:flutter_tunein_attempt3/components/common/selectableTile.dart';
...
class _TracksPageState extends State<TracksPage>
  ...
  BehaviorSubject<List<Tune>> newSongListWithFilters =
      BehaviorSubject<List<Tune>>();
  Map<String, TrackListDeckItemState>? deckItemState;
  Map<String, GlobalKey<State<StatefulWidget>>>? deckItemKeys;
  ...
  void initState() {
    ...
    deckItemStateStream = {"cast": BehaviorSubject<Map<String, dynamic>>()};
  ...
  Widget build(BuildContext context) {
    ...
    double getSongPosition(
        int indexOfThePlayingSong, double numberOfSongsPerScreen) {
      double finalNumber =
          ((((indexOfThePlayingSong) / numberOfSongsPerScreen) -
              ((indexOfThePlayingSong) / numberOfSongsPerScreen).floor()));
    ...
    WidgetsBinding.instance.addPostFrameCallback((duration) {
      ...
      Rx.combineLatest2(musicService.playerState$, newSongListWithFilters,
              (a, b) => MapEntry<MapEntry<PlayerState, Tune>, List<Tune>>(a, b))
          .listen((MapEntry<MapEntry<PlayerState, Tune>, List<Tune>> value) {
          ...
          print("${((((indexOfThePlayingSong)/numberOfSongsPerScreen))*numberOfSongsPerScreen*62)} added value : ${getSongPosition(indexOfThePlayingSong,numberOfSongsPerScreen)} final Value : ${(indexOfThePlayingSong*61.2)+getSongPosition(indexOfThePlayingSong,numberOfSongsPerScreen)}");*/
            ...
            if (controller!.hasClients) {
              controller!.animateTo(
                  ((indexOfThePlayingSong + 1) * 62) +
                      getSongPosition(
                          indexOfThePlayingSong, numberOfSongsPerScreen),
                  duration: Duration(
                      milliseconds:
                          (pow(log(indexOfThePlayingSong * 2), 2)).floor() +
                              50),
                        ...
                        onBuild: () {
                          ...
                          switch (deckItemState!["shuffle"]!.activeNature) {
                            case "auto":
                              {
                                badgeToBe = Icon(
                                    IconData(0xf526, fontFamily: 'fontawesome'),
                                    size: 17,
                      ...
                      TrackListDeckItem(
                        ...
                        onTap: () {
                          if (!deckItemState!["sort"]!.isActive!) {
                            ...
                            toggleApplySortingSongs(
                                deckItemState!["sort"]!.activeNature!);
                          }
                          Widget? badgeToBe;
                          Color? badgeColor;
                          Color? iconColor = Colors.white;
                        ...
                        onLongPress: () async {
                          BehaviorSubject<Map> returnvalue =
                              BehaviorSubject<Map>();
                          item.PopupMenu sortMenu = PopupMenu(
                              ...
                              items: [
                                item.MenuItem(
                                    ...
                                    textStyle: TextStyle(
                                        fontSize: 10.0,
                                        color: (deckItemState!["sort"]!
                                                    .isActive! &&
                                                deckItemState!["sort"]!
                                                        .activeNature ==
                                                    "asc")
                                            ? MyTheme.grey300.withOpacity(.9)
                                            : MyTheme.darkBlack),
                                    image: Icon(
                                      IconData(0xf15e,
                      ...
                      TrackListDeckItem(
                        ...
                        onBuild: () {
                          ...
                          switch (deckItemState!["filter"]!.activeNature) {
                            case "keyword":
                              {
                                badgeToBe = Icon(Icons.keyboard,
                                    color: MyTheme.grey300, size: 17);
                                badgeColor = Colors.transparent;
                                break;
                              }
                            case "artist":
                              {
                                badgeToBe = Icon(Icons.person,
                                    color: MyTheme.grey300, size: 17);
                                badgeColor = Colors.transparent;
                                break;
                              }
                        ...
                        onTap: () {
                          ...
                          if (!deckItemState!["filter"]!.isActive!) {
                            ...
                            //passing the current nature as nature to set would trigger the deactivation
                            //of the sorting. This could be used for all items
                            toggleApplyFiltering(
                                    deckItemState!["filter"]!.activeNature!)
                                .then((data) {
                              returnFirstValue();
                            });
                          }
                          ...
                          PopupMenu sortMenu = PopupMenu(
                              ...
                              items: [
                                item.MenuItem(
                                    ...
                                    textStyle: TextStyle(
                                        fontSize: 10.0,
                                        color: (deckItemState!["filter"]!
                                                    .isActive! &&
                                                deckItemState!["filter"]!
                                                        .activeNature ==
                                                    "keyword")
                                            ? MyTheme.grey300.withOpacity(.9)
                                            : MyTheme.darkBlack),
                      ...
                      TrackListDeckItem(
                        ...
                        onBuild: () {
                          ...
                          if (deckItemState!["cast"]!.isActive! &&
                              (castService.castingState == CastState.CASTING)) {
                            iconColor = MyTheme.darkRed;
                        ...
                        onTap: () {
                          deckItemStateStream!["cast"]!.add({
                            ...
                            "badgeContent": FlashingBadgeIcon(
                              child:
                                  IconData(0xf7c0, fontFamily: 'fontawesome'),
                          ...
                          castService
                              .isDeviceClear(awaitClearance: false)
                              .then((data) {
                            if (!data) {
                          ...
                          PopupMenu sortMenu = PopupMenu(
                              ...
                              onClickMenu: (provider) {
                                ...
                                switch (provider.menuTitle) {
                                  case "Search":
                                    {
                                      DialogService.openDevicePickingDialog(
                                              context, null)
                                          .then((data) {
                                        upnp.Device deviceChosen = data;
                                        if (deviceChosen != null) {
                                          castService
                                              .setDeviceToBeUsed(deviceChosen);
                                          castService.setCastingState(
                                              CastState.CASTING);
                                          deckItemState!["cast"]!.isActive =
                                              true;
                                          saveTrackListDeckSettingsToDisk();
                                          returnFirstValue();
                                        }
                ...
                Flexible(
                  child: StreamBuilder(
                    ...
                    builder: (BuildContext context,
                      ...
                      if (deckItemState != null &&
                          !deckItemState!["shuffle"]!.isActive! &&
                          !deckItemState!["sort"]!.isActive! &&
                          !deckItemState!["filter"]!.isActive!) {
                        _songs.sort((a, b) {
                          return a.title!
                              .toLowerCase()
                              ...
                              child: MyCard(
                                ...
                                onContextSelect: (choice) async {
                                  switch (choice.id) {
                                    ...
                                    case 8:
                                      {
                                        PageRoutes.goToAlbumSongsList(
                                            _songs[newIndex], context);
                                        break;
                                      }
                                    case 9:
                                      {
  ...
  dismissAllShownMenus() {
    ...
    deckItemMenu!.keys.forEach((elem) {
      print(
          "key : ${elem} is shown ? : ${deckItemMenu![elem] != null && deckItemMenu![elem]!.isShow}");
  ...
  Future<bool?>? saveTrackListDeckSettingsToDisk() async {
    ...
    await SettingService.updateSingleSetting(
        SettingsIds.SET_TRACK_LIST_DECK_ITEMS, stringMap);
    return null;
  }

  Map<String, TrackListDeckItemState>? readTrackListDeckSettingsFromDisk() {
    dynamic settingString = SettingService.getCurrentMemorySetting(
        SettingsIds.SET_TRACK_LIST_DECK_ITEMS);
    ...
    if (settingString != null) {
      ...
      mapToBeSaved.keys.forEach((elem) {
        finalMap[elem] =
            TrackListDeckItemState.fromMap(json.decode(mapToBeSaved[elem]));
      });
  ...
  Future<void> toggleApplyFiltering(String nature) async {
    if (deckItemState!["filter"]!.isActive! &&
      ...
      switch (nature) {
        ...
        case "album":
          {
            List<Album?>? albumsToFilterWith =
                await openFilteringAlbumDialog(null);
            if (albumsToFilterWith != null) {
              deckItemState!["filter"]!.activeNature = nature;
              deckItemState!["filter"]!.isActive = true;
              deckItemState!["filter"]!.natureKey = albumsToFilterWith
                  .map((elem) {
                    return elem!.title;
                  })
                  .toList()
        ...
        case "artist":
          {
            List<Artist?>? artistsToFilterWith =
                await openFilteringArtistDialog(null);
            if (artistsToFilterWith != null) {
              deckItemState!["filter"]!.activeNature = nature;
              deckItemState!["filter"]!.isActive = true;
              deckItemState!["filter"]!.natureKey = artistsToFilterWith
                  .map((elem) {
                    return elem!.name;
                  })
                  .toList()
  ...
  Future<void> toggleCasting() async {
    if (deckItemState!["cast"]!.isActive! &&
        castService.currentDeviceToBeUsed.value != null &&
      ...
      bool result = await DialogService.showConfirmDialog(context,
          ...
          message:
              "This will abandon the control of the cast and stop it completely",
      ...
      if (registeredDevice != null) {
        ...
        RequestSettings.pingURL(registeredDevice.url,
          ...
          upnp.Device selectedDevice =
              await DialogService.openDevicePickingDialog(context, null);
            ...
            if (deckItemState!["filter"]!.natureKey != null) {
              ...
              songsValue = songsValue.where((elem) {
                return ((elem.title != null &&
                        elem.title!.toLowerCase().contains(key)) ||
                    (elem.album != null &&
                        elem.album!.toLowerCase().contains(key)) ||
                    (elem.artist != null &&
                        elem.artist!.toLowerCase().contains(key)));
              }).toList();
            }
            break;
          }
                  ...
                  return SelectableTile(
                    ...
                    onTap: (willItBeSelected) {
                      ...
                      if (willItBeSelected) {
                        ...
                        selectedAlbums.removeAt(selectedAlbums
                            .indexWhere((elem) => elem.title == album.title));
                      }
                    },
                  ...
                  return SelectableTile(
                    ...
                    onTap: (willItBeSelected) {
                      ...
                      if (willItBeSelected) {
                        ...
                        selectedArtists.removeAt(selectedArtists
                            .indexWhere((elem) => elem.name == artist.name));
                      }
                    },

...
class _TracksPageState extends State<TracksPage> with AutomaticKeepAliveClientMixin<TracksPage> {
  ...
  void initState() {
    ...
    if (deckItemState == null) {
      deckItemState = {"shuffle": TrackListDeckItemState(), "sort": TrackListDeckItemState(), "filter": TrackListDeckItemState(), "cast": TrackListDeckItemState()};
      saveTrackListDeckSettingsToDisk();
    }
    deckItemKeys = {"shuffle": GlobalKey(), "sort": GlobalKey(), "filter": GlobalKey(), "cast": GlobalKey()};

    deckItemStateStream = {"cast": BehaviorSubject<Map<String, dynamic>>()};

    deckItemMenu = {"shuffle": null, "sort": null, "filter": null, "cast": null};
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((duration) {
      ...
      Rx.combineLatest2(musicService.playerState$, newSongListWithFilters, (a, b) => MapEntry<MapEntry<PlayerState, Tune?>, List<Tune>>(a, b))
        ...
        if (value != null && value.key != null && value.value != null) {
          ...
          print("${((((indexOfThePlayingSong)/numberOfSongsPerScreen))*numberOfSongsPerScreen*62)} added value : ${getSongPosition(indexOfThePlayingSong,numberOfSongsPerScreen)} final Value : ${(indexOfThePlayingSong*61.2)+getSongPosition(indexOfThePlayingSong,numberOfSongsPerScreen)}");*/
            ...
            if (controller!.hasClients) {
              controller!.animateTo(((indexOfThePlayingSong + 1) * 62) + getSongPosition(indexOfThePlayingSong, numberOfSongsPerScreen),
                  duration: Duration(milliseconds: (pow(log(indexOfThePlayingSong * 2), 2)).floor() + 50), curve: Curves.fastOutSlowIn);
            }
          }
        }
      });
            ...
            child: Column(
              children: <Widget>[
                    ...
                    items: [
                      TrackListDeckItem(
                        ...
                        onBuild: () {
                          ...
                          return {"withBadge": deckItemState!["shuffle"]!.isActive, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor};
                        },
                        title: "Shuffle",
                        subtitle: "All Tracks",
                        icon: Icon(
                      ...
                      TrackListDeckItem(
                        ...
                        onBuild: () {
                          ...
                          return {"withBadge": deckItemState!["sort"]!.isActive, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor};
                        },
                        title: "Sort",
                        subtitle: "All Tracks",
                        ...
                        onLongPress: () async {
                          ...
                          item.PopupMenu sortMenu = PopupMenu(
                              ...
                              onDismiss: () {
                                ...
                                returnvalue.add({"withBadge": deckItemState!["sort"]!.isActive, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor});
                              },
                              context: context,
                              items: [
                                item.MenuItem(
                      ...
                      TrackListDeckItem(
                        ...
                        onBuild: () {
                          ...
                          return {"withBadge": deckItemState!["filter"]!.isActive, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor};
                        },
                        onTap: () {
                          BehaviorSubject<Map> returnvalue = BehaviorSubject<Map>();
                          returnFirstValue() {
                            ...
                            returnvalue.add({"withBadge": deckItemState!["filter"]!.isActive, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor});
                          }
                          ...
                          PopupMenu sortMenu = PopupMenu(
                              ...
                              items: [
                                item.MenuItem(
                                    ...
                                    textStyle: TextStyle(
                                        fontSize: 10.0,
                                        color: (deckItemState!["filter"]!.isActive! && deckItemState!["filter"]!.activeNature == "keyword")
                                    ...
                                    image: Icon(
                                      ...
                                      size: 30,
                                      color:
                                          (deckItemState!["filter"]!.isActive! && deckItemState!["filter"]!.activeNature == "keyword") ? MyTheme.grey300.withOpacity(.9) : MyTheme.darkBlack,
                                    )),
                                item.MenuItem(
                                    title: 'Artist',
                                    textStyle: TextStyle(
                                      fontSize: 10.0,
                                      color:
                                          (deckItemState!["filter"]!.isActive! && deckItemState!["filter"]!.activeNature == "artist") ? MyTheme.grey300.withOpacity(.9) : MyTheme.darkBlack,
                                    ),
                                    image: Icon(
                                      Icons.person,
                                      size: 30,
                        ...
                        onBuild: () {
                          ...
                          castService.castingState.distinct().listen((data) {
                            ...
                            if (deckItemStateStream!["cast"] != null) {
                              deckItemStateStream!["cast"]!
                                  .add({"withBadge": false, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor, "icon": iconToBe, "title": title});
                            }
                          });

                          return {"withBadge": false, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor, "icon": iconToBe};
                        },
                        onTap: () {
                          ...
                          returnFirstValue() {
                            ...
                            returnvalue.add({"withBadge": false, "badgeContent": badgeToBe, "badgeColor": badgeColor, "iconColor": iconColor, "icon": iconToBe, "title": title});
                          }
                        ...
                        onLongPress: () {
                          ...
                          PopupMenu sortMenu = PopupMenu(
                              ...
                              items: [
                                item.MenuItem(
                                    title: 'Search',
                                    textStyle: TextStyle(fontSize: 10.0, color: MyTheme.darkBlack),
                                    image: Container(
                                      height: 30,
                                      width: 30,
                                      child: Stack(
                                        children: <Widget>[
                                          ...
                                          Positioned(
                                            child: Icon(Icons.cast, size: 10, color: MyTheme.darkBlack),
                                            left: 9,
                                            top: 9,
                                          )
                                        ],
                              ...
                              onClickMenu: (provider) {
                                ...
                                switch (provider.menuTitle) {
                                  case "Search":
                                    {
                                      DialogService.openDevicePickingDialog(context, null).then((data) {
                ...
                Flexible(
                  child: StreamBuilder(
                    stream: currentSongs,
                    builder: (BuildContext context, AsyncSnapshot<List<Tune>> snapshot) {
                      if (!snapshot.hasData) {
                        return Container();
                      }
                                    ...
                                    case 7:
                                      {
                                        DialogService.showAlertDialog(context,
                                            title: "Song Information", content: SongInfoWidget(null, song: _songs[newIndex]), padding: EdgeInsets.only(top: 10));
                                        break;
                                      }
                                    case 8:
                                      {
        ...
        builder: (_) {
          return AlertDialog(
            ...
            content: TextField(
              ...
              decoration: InputDecoration(hintText: "Type anything", hintStyle: TextStyle(color: MyTheme.grey500.withOpacity(0.2))),
            ),
            actions: <Widget>[
              TextButton(
                child: Text(

...
class _EditPlaylistState extends State<EditPlaylist> {
  ...
  BehaviorSubject<Playlist>? playlistInEditing =
      new BehaviorSubject<Playlist>();
                              ...
                              Expanded(
                                child: (!snapshot.hasData ||
                                    ...
                                    ? GestureDetector(
                                        ...
                                        onTap: () async {
                                          File imageFile = await DialogService
                                              .openImagePickingDialog(context,
                                                  musicService.albums$.value);
                                          if (imageFile != null) {
                                            Playlist newPlaylist =
                                                this.playlistInEditing!.value;
                                            newPlaylist.covertArt =
                                    ...
                                    : (newAlbumArt ==
                                            this.widget.playlist!.covertArt)
                                        ? GestureDetector(
                                            child: Container(
                                              height: 60,
                                              width: 60,
                            ...
                            Flexible(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  if (!removedSongsIds!.contains(
                                      widget.playlist!.songs![index].id)) {
                                      ...
                                      child: item.ReorderableItem(
                                        ...
                                        childBuilder: (context, state) {
                                          return MyCard(
                                            ...
                                            choices:
                                                editPlaylistSongCardContextMenulist,
  ...
  Future<bool?>? OnPopWithUnsavedContent() async {
    if (removedSongsIds!.length > 0) {
      String deletionMessage =
          "Unsaved changes, would you like to save now? Songs that would be deleted : ";

...
import 'package:flutter_tunein_attempt3/pages/metrics/metrics.page.dart';
...
import 'package:flutter_tunein_attempt3/utils/messaginUtils.dart';
...
class _SettingsPageState extends State<SettingsPage>
                        ...
                        sections: [
                          ...
                          SettingsSection(
                            ...
                            tiles: [
                              ...
                              SettingsTile(
                                title: Text('Delete artist thumbnails'),
                                description: Text(
                                    "Delete all downloaded artist thumbnails"),
                                leading: Icon(
                                  Icons.broken_image,
                                  color: MyTheme.grey300,
                                ),
                              ...
                              SettingsTile(
                                ...
                                description: Text(
                                    "Rescan Library for new and old songs"),
                                leading: Icon(
                                  Icons.library_music,
                                  color: MyTheme.grey300,
                                ),
                      ...
                      child: SettingsList(
                        ...
                        sections: [
                          SettingsSection(
                            ...
                            tiles: [
                              SettingsTile(
                                title: Text('Album box animation duration'),
                                description: Text(
                          ...
                          SettingsSection(
                            ...
                            tiles: [
                              SettingsTile(
                                title: Text('Artist box animation duration'),
                                description: Text(
                        ...
                        sections: [
                          SettingsSection(
                            ...
                            tiles: [
                              ...
                              SettingsTile(
                                title: Text('Externally Accessible File list'),
                                description: Text(
                                    "A list of exposed files (that are accessible externally) via the HTTP server"),
                                leading: Icon(
  ...
  Future<dynamic> openNetworkOpenFileList(context) {

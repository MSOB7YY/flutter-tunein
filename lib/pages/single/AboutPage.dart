...
class AboutTuneInPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String mode20LinkedInURL =
        "https://www.linkedin.com/in/med-kadhem-mansour-984922a2/";
    String tuneInGithubURL = "https://github.com/moda20/flutter-tunein";
    String mediaNotificationGithubURL =
        "https://github.com/moda20/flutter_media_notification";
    String metaDataGithubURL =
                                        ...
                                        child: Container(
                                          child: SingleChildScrollView(
                                            ...
                                            child: RichText(
                                              ...
                                              text: TextSpan(
                                                text:
                                                    "TuneIn is a music application built using Flutter. This project is not the first music player i have sought to do\", "
                            ...
                            SliverToBoxAdapter(
                              child: Material(
                                child: Container(
                                  height: 35,
                                  child: ItemListDevider(
                                      DeviderTitle: "The Creator: Moda20"),
                                ),
                                color: Colors.transparent,
                              ),
                            ),
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        child: Text(
                                          "The following packages are part of TuneIn and are also maintained by Moda20",
                                          style: TextStyle(
                                            color: MyTheme.grey300,
                                            fontWeight: FontWeight.w400,
                                            fontSize: 15,
                                          ...
                                          child: Column(
                                            children: <Widget>[
                                              SelectableTile.mediumWithSubtitle(
                                                ...
                                                subtitle:
                                                    "A custom player notification controls",
                                                leadingWidget: Icon(
                                                  IconData(0xE057,
                                                      fontFamily:
                                                          'ligaturesymbols'),
                                                ...
                                                onTap: (data) {
                                                  openGithub(
                                                      mediaNotificationGithubURL);
                                                },
                                              ),
                                              SelectableTile.mediumWithSubtitle(
                                                title: "AudioPlayer",
                                                subtitle:
                                                    "An complete mp3 audio player",
                                                leadingWidget: Icon(
                                                  IconData(0xE057,
                                                      fontFamily:
                                                          'ligaturesymbols'),
                                                ...
                                                onTap: (data) {
                                                  openGithub(
                                                      audioPlayerGithubURL);
                                                },
                                              ),
                                              SelectableTile.mediumWithSubtitle(
                                                title: "File MetaData",
                                                subtitle:
                                                    "A file meta data parser",
                                                leadingWidget: Icon(
                                                  IconData(0xE057,
                                                      fontFamily:
                                                          'ligaturesymbols'),

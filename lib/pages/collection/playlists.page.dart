...
import 'package:flutter_tunein_attempt3/components/playlistCell.dart';
...
import 'package:flutter_tunein_attempt3/pages/management/AddSongsToPlaylist.dart';
import 'package:flutter_tunein_attempt3/pages/management/EditPlaylist.dart';
...
class _PlaylistsPageState extends State<PlaylistsPage>
                                      ...
                                      case 2:
                                        {
                                          ...
                                          musicService.playMusic(
                                              _currentPlaylist.songs![0],
                                              isPartOfAPlaylist: true,
                                      ...
                                      case 5:
                                        {
                                          deletePlaylist(
                                              _currentPlaylist, context,
                                              message:
                                                  "Confirm deleting the playlist : \"${_currentPlaylist.name}\"");
                                        }
                                    }
                                  },
                                  onContextCancel: () {
  ...
  dynamic openEditPlaylistPage(Playlist playlist, context) async {
    ...
    MapEntry<List<String>, String> returnedSongsToBeDeleted =
    ...
    if (returnedSongsToBeDeleted != null &&
        returnedSongsToBeDeleted.key.length != 0) {
              ...
              TextButton(
                ...
                onPressed: () {
                  Playlist playlist = new Playlist(
                      this.newPlaylistName!, [], PlayerState.stopped, null);
                  musicService.addPlaylist(playlist).then((data) {
